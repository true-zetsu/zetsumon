...
extern const u8 gText_EffectiveOff[];
extern const u8 gText_EffectiveOn[];
extern const u8 gText_ExpShareOptOff[];
extern const u8 gText_ExpShareOptOn[];
...
extern const u8 gText_BirchEasy[];
extern const u8 gText_BirchNormal[];
extern const u8 gText_BirchHard[];
extern const u8 gText_BirchRepeat[];
...
extern const u8 gText_TrainerMemo[];
...
extern const u8 gText_AttackHGSS[];
extern const u8 gText_DefenseHGSS[];
extern const u8 gText_SpAtkHGSS[];
extern const u8 gText_SpDefHGSS[];
extern const u8 gText_SpeedHGSS[];
extern const u8 gText_HPHGSS[];
extern const u8 gText_DexNumberHGSS[];
extern const u8 gText_OTSlashHGSS[];
extern const u8 gText_SpeciesHGSS[];
extern const u8 gText_IDNumberHGSS[];
extern const u8 gText_RentalPkmnHGSS[];
extern const u8 gText_TypeSlashHGSS[];
extern const u8 gText_PowerHGSS[];
extern const u8 gText_AccuracyHGSS[];
extern const u8 gText_AppealHGSS[];
extern const u8 gText_JamHGSS[];
extern const u8 gText_StatusHGSS[];
extern const u8 gText_ExpPointsHGSS[];
extern const u8 gText_NextLvHGSS[];
extern const u8 gText_RibbonsVar1HGSS[];
extern const u8 gText_SwitchHGSS[];
extern const u8 gText_PkmnInfoHGSS[];
extern const u8 gText_TrainerMemoHGSS[];
