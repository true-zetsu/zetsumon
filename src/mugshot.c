...
static const u32 sMugshotImg_Steven[] = INCBIN_U32("graphics/trainers/mugshot/steven.4bpp.lz");
static const u16 sMugshotPal_Steven[] = INCBIN_U16("graphics/trainers/mugshot/steven.gbapal");

static const struct Mugshot sMugshots[] = {
    [MUGSHOT_STEVEN] = {.x = 23, .y = 9, .width = 40, .height = 40, .image = sMugshotImg_Steven, .palette = sMugshotPal_Steven},
};
