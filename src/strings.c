...
const u8 gText_BirchEasy[] = _("EASY");
const u8 gText_BirchNormal[] = _("NORMAL");
const u8 gText_BirchHard[] = _("HARD");
const u8 gText_BirchRepeat[] = _("Repeat");
...
const u8 gText_AttackHGSS[] = _("Attack");
const u8 gText_DefenseHGSS[] = _("Defense");
const u8 gText_SpAtkHGSS[] = _("Sp. Atk");
const u8 gText_SpDefHGSS[] = _("Sp. Def");
const u8 gText_SpeedHGSS[] = _("Speed");
const u8 gText_HPHGSS[] = _("HP");
const u8 gText_DexNumberHGSS[] = _("Dex");
const u8 gText_OTSlashHGSS[] = _C("OT");
const u8 gText_SpeciesHGSS[] = _("Species");
const u8 gText_IDNumberHGSS[] = _("ID No.");
const u8 gText_RentalPkmnHGSS[] = _("Rental Pokémon");
const u8 gText_TypeSlashHGSS[] = _("Type");
const u8 gText_PowerHGSS[] = _("Power");
const u8 gText_AccuracyHGSS[] = _("Accuracy");
const u8 gText_AppealHGSS[] = _("Appeal");
const u8 gText_JamHGSS[] = _("Jam");
const u8 gText_StatusHGSS[] = _("");
const u8 gText_ExpPointsHGSS[] = _("Exp. Points");
const u8 gText_NextLvHGSS[] = _("To Next Lv.");
const u8 gText_RibbonsVar1HGSS[] = _("Ribbons: {STR_VAR_1}");
const u8 gText_SwitchHGSS[] = _("Switch");
const u8 gText_PkmnInfoHGSS[] = _("Pokémon Info");
const u8 gText_TrainerMemoHGSS[] = _("Trainer Memo");
const u8 gText_PkmnSkillsHGSS[] = _("Skills");
const u8 gText_BattleMovesHGSS[] = _("Moves");
const u8 gText_ContestMovesHGSS[] = _("Contest");
const u8 gText_ItemHGSS[] = _("Item");
...
const u8 gText_Effective[] = _("SHOW EFFECTIVE");
const u8 gText_ExpShare[] = _("EXP. SHARE");
const u8 gText_DescriptionEnter[] = _("Press {START_BUTTON} to view description.");
const u8 gText_DescriptionExit[] = _("Press {START_BUTTON} to exit description.");
const u8 gText_DifficultyDesc[] = _("{COLOR RED}{SHADOW LIGHT_RED}EASY{COLOR GREEN}{SHADOW LIGHT_GREEN}: No restrictions. Easy AI.\n{COLOR RED}{SHADOW LIGHT_RED}NORMAL{COLOR GREEN}{SHADOW LIGHT_GREEN}: 4 max in-battle items. Soft\nlevel caps. Difficult AI.\n{COLOR RED}{SHADOW LIGHT_RED}HARD{COLOR GREEN}{SHADOW LIGHT_GREEN}: No items in-battle. Hard level\ncaps. Cruel AI.");
const u8 gText_EffectiveDesc[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Color the type of the moves\nin battle based on\ntype-effectiveness.");
const u8 gText_ExpShareDesc[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Shared experience between the\nwhole party, regardless of whether\nthe Pokémon battled or not.");
const u8 gText_Warning[] = _("{COLOR RED}{SHADOW LIGHT_RED}WARNING!");
const u8 gText_LowerDifficultyWarning[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}A lower difficulty has been detected.\nOnce you set a lower difficulty, you\n{COLOR RED}{SHADOW LIGHT_RED}cannot{COLOR GREEN}{SHADOW LIGHT_GREEN} select a higher difficulty.\nMake sure you know what\nyou are doing.");
const u8 gText_LowerDifficultyExit[] = _("Press {A_BUTTON} + {START_BUTTON} to confirm. {B_BUTTON} to cancel.");
const u8 gText_HigherDifficultyWarning[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}A higher difficulty has been detected.\nYou {COLOR RED}{SHADOW LIGHT_RED}cannot{COLOR GREEN}{SHADOW LIGHT_GREEN} change to a difficulty\nhigher than your current setting.");
const u8 gText_HigherDifficultyExit[] = _("Press {B_BUTTON} to go back.");
...
const u8 gText_EffectiveOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_EffectiveOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_ExpShareOptOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_ExpShareOptOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
...
const u8 gText_CharacteristicHP1[] = _("Loves to eat.");
const u8 gText_CharacteristicHP2[] = _("Takes plenty of siestas.");
const u8 gText_CharacteristicHP3[] = _("Nods off a lot.");
const u8 gText_CharacteristicHP4[] = _("Scatters things often.");
const u8 gText_CharacteristicHP5[] = _("Likes to relax.");
const u8 gText_CharacteristicAtk1[] = _("Proud of its power.");
const u8 gText_CharacteristicAtk2[] = _("Likes to thrash about.");
const u8 gText_CharacteristicAtk3[] = _("A little quick tempered.");
const u8 gText_CharacteristicAtk4[] = _("Likes to fight.");
const u8 gText_CharacteristicAtk5[] = _("Quick tempered.");
const u8 gText_CharacteristicDef1[] = _("Sturdy body.");
const u8 gText_CharacteristicDef2[] = _("Capable of taking hits.");
const u8 gText_CharacteristicDef3[] = _("Highly persistent.");
const u8 gText_CharacteristicDef4[] = _("Good endurance.");
const u8 gText_CharacteristicDef5[] = _("Good perseverance.");
const u8 gText_CharacteristicSpA1[] = _("Highly curious.");
const u8 gText_CharacteristicSpA2[] = _("Mischievous.");
const u8 gText_CharacteristicSpA3[] = _("Thoroughly cunning.");
const u8 gText_CharacteristicSpA4[] = _("Often lost in thought.");
const u8 gText_CharacteristicSpA5[] = _("Very finicky.");
const u8 gText_CharacteristicSpD1[] = _("Strong willed.");
const u8 gText_CharacteristicSpD2[] = _("Somewhat vain.");
const u8 gText_CharacteristicSpD3[] = _("Strongly defiant.");
const u8 gText_CharacteristicSpD4[] = _("Hates to lose.");
const u8 gText_CharacteristicSpD5[] = _("Somewhat stubborn.");
const u8 gText_CharacteristicSpe1[] = _("Likes to run.");
const u8 gText_CharacteristicSpe2[] = _("Alert to sounds.");
const u8 gText_CharacteristicSpe3[] = _("Impetuous and silly.");
const u8 gText_CharacteristicSpe4[] = _("Somewhat of a clown.");
const u8 gText_CharacteristicSpe5[] = _("Quick to flee.");
