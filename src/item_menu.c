...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    [ITEM_GALARICA_TWIG] = ITEM_TYPE_TRADEABLE,
    [ITEM_ARMORITE_ORE] = ITEM_TYPE_TRADEABLE,
    [ITEM_DYNITE_ORE] = ITEM_TYPE_TRADEABLE,
    ...
    [ITEM_PEWTER_CRUNCHIES] = ITEM_TYPE_BATTLE_ITEM,
