...
const u32 gSummaryScreen_HGSS_Gfx[]                = INCBIN_U32("graphics/summary_screen/hgss/tiles.4bpp.lz");
const u32 gSummaryScreen_HGSS_Pal[]                = INCBIN_U32("graphics/summary_screen/hgss/tiles.gbapal.lz");
const u32 gSummaryPage_Info_HGSS_Tilemap[]         = INCBIN_U32("graphics/summary_screen/hgss/page_info.bin.lz");
const u32 gSummaryPage_Memo_HGSS_Tilemap[]         = INCBIN_U32("graphics/summary_screen/hgss/page_memo.bin.lz");
const u32 gSummaryPage_Skills_HGSS_Tilemap[]       = INCBIN_U32("graphics/summary_screen/hgss/page_skills.bin.lz");
const u32 gSummaryPage_BattleMoves_HGSS_Tilemap[]  = INCBIN_U32("graphics/summary_screen/hgss/page_battle_moves.bin.lz");
const u32 gSummaryPage_ContestMoves_HGSS_Tilemap[] = INCBIN_U32("graphics/summary_screen/hgss/page_contest_moves.bin.lz");
const u32 gSummaryPage_InfoEgg_HGSS_Tilemap[]      = INCBIN_U32("graphics/summary_screen/hgss/page_info_egg.bin.lz");
